    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "123 Main St", "john.doe@example.com", "John", true, "Doe" },
                    { 2, "456 Elm St", "jane.smith@example.com", "Jane", true, "Smith" },
                    { 3, "789 Oak St", "emily.johnson@example.com", "Emily", true, "Johnson" },
                    { 4, "101 Pine St", "michael.brown@example.com", "Michael", true, "Brown" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Dune", 1, null },
                    { 2, 1, "1984", 1, null },
                    { 3, 2, "A Brief History of Time", 1, null },
                    { 4, 3, "Becoming", 1, null },
                    { 5, 4, "Sherlock Holmes", 4, null },
                    { 6, 5, "Harry Potter", 4, null },
                    { 7, 6, "Pride and Prejudice", 2, null },
                    { 8, 7, "The Shining", 3, null },
                    { 9, 5, "The Hobbit", 1, null },
                    { 10, 5, "The Witcher", 4, null },
                    { 11, 6, "The Great Gatsby", 2, null },
                    { 12, 7, "It", 3, null }
                });
